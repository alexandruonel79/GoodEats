...
const addComment = async (req, res) => {
    try {
        ...
        const { text } = req.body;
        const newComment = await Comment.create({ text, likes: 0, postId, userId: req.user.id });
...
module.exports = { createPost, getAllPosts, addComment, likePost, likeComment, upload, getUserProfilePicture, unlikeComment, unlikePost, checkIfUserLikedPost, checkIfUserLikedComment, deletePost };
